...
void State::updateVisionInformation()
{
    ...
    for(int a=0; a<(int) my_ants.size(); a++)
    {
        sLoc = my_ants[a];
        locQueue.push(sLoc);
        ...
        grid[sLoc.row][sLoc.col].explored = 1;
    ...
    else
    {
        ...
        while(is >> inputType)
        {
            ...
            else if(inputType == "a") //live ant square
            {
                ...
                if(player == 0)
									state.my_ants.push_back(Location(row, col));
                else
                    state.enemy_ants.push_back(Location(row, col));
            }
            ...
            else if(inputType == "h")
            {
                ...
                if(player == 0)
                    state.my_hills.push_back(Location(row, col));
                else
                    state.enemy_hills.push_back(Location(row, col));
